...
function App() {
  ...
  const [uglyData, setUglyData] = useState([])
    ...
    // GET REQUEST
  useEffect(() => {
    axios.get("https://api.vschool.io/takeshigarcia/thing")
 ...
 function InputListener(e){
  ...
  setInputData(prevData => ({
    ...
    [name]: value
      ...
      function submitUglyData() {
        axios.post("https://api.vschool.io/takeshigarcia/thing", inputData)
          .then(res => {
          ...
          .catch(error => {
            ...
            console.error("Error submitting ugly data:", error);
          });
      }

  // DELETE BUTTON
  function deleteUgly(id){
    axios.delete(`https://api.vschool.io/takeshigarcia/thing/${id}`)
  ...
  function editUgly(id, editField){
    axios.put(`https://api.vschool.io/takeshigarcia/thing/${id}`, editField)
      .then(setUglyData(prevUglyData => {
